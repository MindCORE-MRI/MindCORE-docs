...
----------
The EEG recording room
^^^^^^^
The EEG recording room (room #146) is electrically-shielded and `shown to have very low noise <../how-tos/EEG_noise>`_. Participants should be comfortably seated in front of the monitor. The EEG amplifier is located on a cart, which can be positioned behind the participant to reduce strain on the cable connections between the cap and amplifier.
Murphy bed
^^^^^^^
...
Make sure the switch is powered on. Use the buttons marked "Stim" and "Rec" to select the stimulus control and recording computers, respectively. **Both computers must be powered on for the KVM switch to work properly**

Brain Vision Tips and Links
--------
...
* `How to clean the actiCAP slim electrodes <https://www.brainproducts.com/download/how-to-clean-the-acticap-slim/>`_  
* `Ground electrode tips <https://www.youtube.com/watch?v=RtKp8R6IOto>`_ 
* `PowerUnit proper care <https://www.brainproducts.com/download/how-to-keep-your-powerunit-fit-and-well/>`_
